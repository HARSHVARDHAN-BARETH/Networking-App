    ...
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        <View style={styles.inputRow}>
          ...
          <TextInput placeholder='Enter Name' placeholderTextColor="#888"
        ...
        <View style={styles.inputRow}>
          ...
          <TouchableOpacity style={{width:'98%',marginTop:30, backgroundColor:'#1e90ff',padding:10, justifyContent:'center',alignSelf:'center', alignItems:'center'}}>
            <Text style={{fontSize:20, color:'#fff'}}>Submit</Text>
          </TouchableOpacity>
          <Text style={{marginLeft:18, marginTop:10,fontSize:20}} onPress={() => {
                  router.dismissAll(); // Close any modals or previous screens
                  router.push('/signin'); // Navigate to the signup screen
